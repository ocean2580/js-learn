document.addEventListener('DOMContentLoaded',function(){
  ...
  class Game {
    ...
    update(deltaTime) {
      this.enemies = this.enemies.filter(e => !e.markorDeletion);
  ...
  class Enemy {
    ...
    update(deltaTime) {
      ...
      if(this.x<0-this.width) this.markorDeletion = true;
  ...
  class Spider extends Enemy {
    constructor(game) {
      ...
      // this.image = new Image();
      // this.image.src = 'enemy_spider.png';
      this.image = spider;
      this.speed = 0;
    ...
    update(deltaTime) {
      ...
      if(this.y<0-this.height*2) this.markorDeletion = true;
